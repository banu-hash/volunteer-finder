import { c as createLucideIcon, j as jsxRuntimeExports, d as LoadingSpinner, r as reactExports, a as cn, B as Button, J as Users, a7 as Building2, a8 as CircleAlert, C as ClipboardList, e as CircleCheck, H as Link, a9 as Clock } from "./index-D4bjddjr.js";
import { u as usePlatformStats, a as useActivityLog, b as usePendingNGOs } from "./admin-BzL0N7YX.js";
import { T as TrendingUp } from "./trending-up-B8guMjXx.js";
import { R as ResponsiveContainer, H as LineChart, z as CartesianGrid, X as XAxis, Y as YAxis, E as Tooltip, I as Line, B as BarChart, F as Bar } from "./BarChart-B-YkxqkT.js";
/**
...
function ActivityLogTable({ logs, isLoading }) {
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "md", label: "Loading activity..." })
      }
    );
  }
  if (!logs.length) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", "data-ocid": "activity_log.table", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-muted-foreground font-medium text-xs uppercase tracking-wide pb-3 pr-4", children: "Time" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-muted-foreground font-medium text-xs uppercase tracking-wide pb-3 pr-4", children: "Action" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left text-muted-foreground font-medium text-xs uppercase tracking-wide pb-3", children: "Details" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: logs.slice(0, 20).map((log, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        className: "hover:bg-muted/30 transition-colors",
        "data-ocid": `activity_log.item.${i + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4 text-muted-foreground whitespace-nowrap font-mono text-xs", children: timeAgo(log.timestamp) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4 whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `font-medium ${getActionColor(log.action)}`, children: log.action }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 text-muted-foreground truncate max-w-xs", children: log.details })
        ]
      },
      log.id.toString()
    )) })
    ...
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs font-medium uppercase tracking-wide mb-1", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-3xl font-bold text-foreground leading-none", children: value }),
          subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-1", children: subtitle })
        ] })
      ]
    }
  );
...
function AdminOverviewPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 max-w-7xl mx-auto space-y-8", children: [
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Monitor and manage the Volunteer Finder System" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
    ...
    statsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4", children: ["vol", "ngo", "pending", "tasks", "completed", "rate"].map((id2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "admin_overview.quick_actions.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-lg mb-4", children: "Quick Actions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: quickActions.map((action, i) => {
        const Icon = action.icon;
        const badge = action.title === "Approve NGOs" && pendingCount > 0 ? pendingCount : null;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
              ...
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-muted flex items-center justify-center group-hover:bg-primary/10 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 text-muted-foreground group-hover:text-primary transition-smooth" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm text-foreground", children: action.title }),
                        badge && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center justify-center w-5 h-5 text-xs font-bold rounded-full bg-destructive text-destructive-foreground", children: badge })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5", children: action.description })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-muted-foreground group-hover:text-primary group-hover:translate-x-1 transition-smooth shrink-0 mt-3" })
                ]
              }
            )
          },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-lg mb-4", children: "Analytics" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-sm text-foreground mb-4", children: "Signups — Last 30 Days" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: signupData, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CartesianGrid,
                  {
                    strokeDasharray: "3 3",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-sm text-foreground mb-4", children: "Tasks by Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: taskStatusData, barSize: 28, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  CartesianGrid,
                  {
                    strokeDasharray: "3 3",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "admin_overview.activity.section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-foreground text-lg", children: "Recent Activity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-3.5 h-3.5" }),
          "Live feed"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl p-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ActivityLogTable, { logs, isLoading: logsLoading }) })
    ] })
  ] });
}
export {
