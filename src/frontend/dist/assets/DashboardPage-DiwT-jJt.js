...
function TasksByStatusChart({ tasks }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data, margin: { top: 4, right: 4, left: -20, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(var(--border))" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value", radius: [4, 4, 0, 0], children: data.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Cell,
      {
...
function TaskCompletionsLineChart({ tasks }) {
  const data = reactExports.useMemo(() => {
    const now = Date.now();
    const days = {};
    for (let i = 29; i >= 0; i--) {
    ...
    for (const task of tasks) {
      if (task.status === TaskStatus.completed || task.status === TaskStatus.verified) {
        const d = new Date(Number(task.updatedAt / 1000000n));
        const key = `${d.getMonth() + 1}/${d.getDate()}`;
        if (key in days) days[key]++;
      }
    }
    const entries = Object.entries(days);
    return entries.filter((_, i) => i % 3 === 0 || i === entries.length - 1).map(([name, value]) => ({ name, value }));
  }, [tasks]);
...
function PriorityPieChart({ tasks }) {
  const data = reactExports.useMemo(() => {
    let normal = 0;
    let urgent = 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Pie,
      {
        ...
        labelLine: false,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: CHART_COLORS.teal }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: CHART_COLORS.amber })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: tooltipStyle() })
...
function StatCard({ label, value, icon, accent, ocid }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `p-4 rounded-xl border transition-smooth ${accent ? "bg-primary/10 border-primary/30" : "bg-card border-border"}`,
      "data-ocid": ocid,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: accent ? "text-primary" : "text-muted-foreground", children: icon })
        ] }),
...
function DashboardPage() {
  ...
  const stats = reactExports.useMemo(() => {
    ...
    const assignedVolunteers = new Set(
      tasks.filter((t) => t.assignedVolunteer).map((t) => {
        var _a;
        return (_a = t.assignedVolunteer) == null ? void 0 : _a.toString();
      })
    ).size;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 p-4 md:p-6", "data-ocid": "ngo-dashboard.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground", children: "NGO Dashboard" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Monitor your tasks and volunteer engagement" })
      ] }),
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4", children: ["s1", "s2", "s3", "s4"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 rounded-xl" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-lg text-foreground", children: "Analytics" }),
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: ["c1", "c2", "c3"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-56 rounded-xl" }, k)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3", children: "Tasks by Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TasksByStatusChart, { tasks })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3", children: "Completions (30 days)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TaskCompletionsLineChart, { tasks })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-foreground mb-3", children: "Priority Distribution" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(PriorityPieChart, { tasks })
            ] })
          ] })
        ]
      }
      ...
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-lg text-foreground", children: "Recent Tasks" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: "/ngo/tasks",
          ...
          isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: ["t1", "t2", "t3"].map((k) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-lg" }, k)) }) : recentTasks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "No tasks yet" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Create your first task to get started" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
                    to: "/ngo/tasks",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: recentTasks.map((task, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(TaskCard, { task, index: i + 1 }, task.id.toString())) })
        ]
      }
    )
  ] });
